...
import src.main.java.metier.Classement;
...
public class ClassementHtmlDAO
{
    ...
    public void deleteClassementHtml(src.main.java.classement.Classement classement)
    {
        Statement stm;
        try
        {
    ...
    public void insertClassement(src.main.java.classement.Classement classement, StringBuilder html)
    {
