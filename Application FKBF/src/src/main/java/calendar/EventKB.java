...
public class EventKB
{
    ...
    {
        return "EventKB [debut=" + debut + ", fin=" + fin + ", isHomme=" + isHomme + ", equipeBleu=" + equipeBleu
            + ", equipeGris=" + equipeGris + ", equipeNoir=" + equipeNoir + ", calendarEventEntry="
            + calendarEventEntry + ", idMatch=" + idMatch + "]";
    }
