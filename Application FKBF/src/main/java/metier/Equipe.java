    ...
    implements java.io.Serializable
{
                  ...
                  String esprit_sportif, String points)
    {
        ...
        {
            this.prolDeuxieme = Integer.parseInt(prol_deuxieme);
        }
        ...
        {
            this.nbPeriode = Integer.parseInt(nb_periode);
        }
        if(esprit_sportif == null || esprit_sportif.equals(""))
        {
            this.espritSportif = 0;
        }
        else
        {
            this.espritSportif = Integer.parseInt(esprit_sportif);
        }
